...
class PhoneTracking:
    ...
    def __init__(self):
        ...
        self.tracked_image_pub = rospy.Publisher("/tracked_image", Image, queue_size = 30)
        self.phone_pose_camera_pub = rospy.Publisher("/phone_pose_camera", PoseStamped, queue_size = 70)
