...
image = cv2.imread(r'C:\Users\Lenovo\Downloads\wombat_tracking\images\s22\2.png')
...
# thresh = cv2.dilate(thresh, kernel, iterations=2)
# thresh =cv2.bitwise_not(thresh)
# thresh[:,CROP_X:CROP_X+5] = 0
# thresh[:,CROP_X+CROP_W-5:CROP_X+CROP_W] = 0
